...
- **Lines and pricing:** product/bundle/service lines snapshot catalog values. Support quantity and booking-only price overrides, fixed _or_ percent discount, deterministic taxable discount/tax calculation, subtotal, a refundable deposit automatically recommended at 60% of replacement value with an explicit override, total, and revenue excluding refundable deposit. The calculation is pure and tested.
